...
import cn.ymsys.api.common.websocket.config.CreateGroupConfig;
...
public class CreateGroupRequestHandler extends SimpleChannelInboundHandler<CreateGroupRequestPacket> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, CreateGroupRequestPacket msg) throws Exception {
        CreateGroupConfig createGroupConfig = SpringContextUtil.getBean(CreateGroupConfig.class);
        msg.getUserIdList();
        for (Group group : createGroupConfig.getGroups()) {
            List<String> userIdList = createGroupConfig.getGroupUsers().get(group.getId());
            ...
            createGroupResponsePack.setGroupId(group.getId());
