...
public class CollectionUtil {
    ...
    public static <C extends Collection<V>, V> Set<String> toSet$String(C collection) {
    ...
    public static Set<String> toSet$FieldName4Schema(List<FieldAttribute> fields) {
        ...
        for(FieldAttribute fieldAttribute : fields) {
            set.add(fieldAttribute.getName());
        }
        return set;
    }

    public static Map<String, FieldAttribute> toMap$FieldAttribute4Schema(List<FieldAttribute> fields) {

        TreeMap<String, FieldAttribute> map = new TreeMap<String, FieldAttribute>();
        if(DataUtil.isEmpty(fields))
            return map;

        for(FieldAttribute fieldAttribute : fields) {
            map.put(fieldAttribute.getName(), fieldAttribute);
        }
        return map;
    }
}
